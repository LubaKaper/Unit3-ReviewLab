//
//  Unit3_ReviewLabTests.swift
//  Unit3-ReviewLabTests
//
//  Created by Liubov Kaper  on 12/18/19.
//  Copyright © 2019 Luba Kaper. All rights reserved.
//

import XCTest

@testable import Unit3_ReviewLab
...
class PodcastsTests: XCTestCase {
  ...
  func testPodcastModel() {
    ...
    // act
    let searchResults = try! JSONDecoder().decode(PodcastArray.self, from: jsonData)
